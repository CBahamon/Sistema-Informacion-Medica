...
--
-- Host: localhost    Database: sistema_informacion
-- ------------------------------------------------------
...
CREATE TABLE `consultorio` (
  ...
  `direccion_consultorio` varchar(45) DEFAULT NULL,
...
INSERT INTO `consultorio` VALUES (1,'medimas','calle 45',5,1);
/*!40000 ALTER TABLE `consultorio` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `consutorio`
--

DROP TABLE IF EXISTS `consutorio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `consutorio` (
  `id_consultorio` bigint NOT NULL,
  `direccion_consultorio` bigint NOT NULL,
  `id_departamento` bigint NOT NULL,
  `id_municipio` bigint NOT NULL,
  `nombre_consultorio` bigint NOT NULL,
  PRIMARY KEY (`id_consultorio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `consutorio`
--

LOCK TABLES `consutorio` WRITE;
/*!40000 ALTER TABLE `consutorio` DISABLE KEYS */;
/*!40000 ALTER TABLE `consutorio` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `persona` (
  ...
  `direccion_persona` varchar(45) DEFAULT NULL,
  `rol_persona` int DEFAULT NULL,
  `password_persona` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_persona`),
  KEY `id_rol_idx` (`rol_persona`),
  CONSTRAINT `id_rol` FOREIGN KEY (`rol_persona`) REFERENCES `rol` (`id_rol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `persona` VALUES (12,'cristian','bahamon','314','ca@g.com','calel 3',2,'123'),(123,'camilo','castallo','320','castallo@gmail.com','calle 50',3,'123'),(1193126104,'cristian','bahamon','3144803345','camilo@gmail.com','calle 45 # 21-27',1,'123');
...
-- Dump completed on 2022-04-04  3:52:50
